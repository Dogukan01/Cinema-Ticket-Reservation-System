...
export default function MovieBooking() {
    ...
    const handleMovieChange = (newMovieId) => {
        ...
        navigate(`/movies/${newMovieId}/booking`, { replace: true });
    };
    ...
    return (
        <div style={{ maxWidth: '1440px', margin: '0 auto', paddingBottom: '20px' }}>
            <Link to={`/movies/${activeMovieId}`} style={{ color: 'var(--text-secondary)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '10px', fontWeight: '600', transition: 'color 0.2s ease' }}
